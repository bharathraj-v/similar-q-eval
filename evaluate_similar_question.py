#!/usr/bin/env python3
"""
Production-ready FastAPI server for Similar Questions Evaluation
"""
...
def load_config() -> Dict[str, Any]:
    ...
    try:
        with open('configs/evaluation_prompts.yaml', 'r', encoding='utf-8') as file:
            return yaml.safe_load(file)
    except FileNotFoundError:
        logger.error("configs/evaluation_prompts.yaml file not found. Please ensure it exists in the current directory.")
        raise
    except yaml.YAMLError as e:
        logger.error(f"Error parsing configs/evaluation_prompts.yaml: {str(e)}")
        raise
