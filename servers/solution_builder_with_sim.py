...
async def lifespan(app: FastAPI):
    global config_data
    logger.info("Starting up Solution Builder API (with Similar Questions)")
    try:
    ...
    logger.info("Shutting down Solution Builder API (with Similar Questions)")
...
if __name__ == "__main__":
    ...
    uvicorn.run("solution_builder_with_sim:app", **server_config)
